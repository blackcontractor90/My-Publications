...
|---|---|---|---|---|---|
| Scalable Metaheuristic Optimization of Asymmetric and Clustered TSP Variants using Iterated Local Search | Farid Morsidi | Journal of Telecommunication, Electronic and Computer Engineering | 2026 |  | [link](https://doi.org/10.54554/jtec.2026.18.01.005) |
| MLP Sliding-Window Forecasting for Electricity Load Prediction : A Multi-Scale Evaluation using an ONNX-based Java Framework | Farid Morsidi, Asma Hanee Ariffin, Rohaizah Abdul Wahid | Journal of Applied Engineering Design & Simulation | 2026 |  | [link](https://doi.org/10.24191/jaeds.v6i1.164) |
